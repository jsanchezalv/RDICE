...
evt_react_list <-
  ...
  add_reactevt(name_evt = "progression.mbc",
               input = {
                 ...
                 cur_evtlist["2ndline_mbc"] <-  curtime + draw_tte(1,'exp', log(0.08))/12
  ...
  add_reactevt(name_evt = "ttot.early",
               input = {
                 ...
                 if (n_ae>0) {
                    cur_evtlist <- c(cur_evtlist,rep(setNames(curtime + 0.0001,"ae"),n_ae))
                 }
               }) %>%
  ...
  add_reactevt(name_evt = "ae",
               input = {
                 ...
                 q_default <- if (fl.idfs==1) {
                             ...
                             cur_evtlist["os"] <- max(cur_evtlist[["os"]] - 0.125,curtime +0.0001) #each AE brings forward death by 1.5 months
               }) %>%
